package com.mx.ux.unidad3.genericos.contextualizacion01;
...
//MotorAceptaciones
class MotorAceptaciones implements ProcesadorDeDatos<Boolean,String, String>{

    @Override
    public void procesarSecuencia(List<Boolean> elementos) {
